...
package sifive.fpgashells.shell.xilinx.ebaz4205shell
...
import sifive.fpgashells.ip.xilinx.{IBUFG, IOBUF, PULLUP, armps, mmcm, reset_sys, PowerOnResetFPGAOnly}

//-------------------------------------------------------------------------
// Ebaz4205
//-------------------------------------------------------------------------

abstract class Ebaz4205Shell(implicit val p: Parameters) extends RawModule {
  ...
  //-----------------------------------------------------------------------
  // Mixed-mode clock and Reset generator

  val armps_0 = Module(new armps())

  CLK100MHZ := armps_0.io.FCLK_CLK0_0
  ck_rst := armps_0.io.FCLK_RESET0_N_0
